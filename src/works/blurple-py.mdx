---
name: "blurple-py"
subtitle: "open-source python library for building user experiences in discord"
date: "2021-02"
preview: "/media/blurple-py_1.webp"
tags:
  - "lib"
tools:
  - "discord.py"
...
collage:
  - src: "/media/blurple-py_7.webm"
    caption: "a kitchen-sink showcase of what this library can do!"
  - src: "/media/blurple-py_1.webp"
    caption: "the documentation page for blurple.py"
  - src: "/media/blurple-py_3.webp"
    caption: "different style options for alerts"
desc:
  - |
    i extracted, refactored, and published a couple of useful complex features i built for a different discord bot into an open-source library to be useful to others, and redesigned the api in the process.
  - |
    features include asnycio abstractions to allow for simplistic multi-step commands, and a consistent design system with pre-built ui components to help users move faster and communicate intent more effectively.
---
...
<Figure src="/media/blurple-py_5.webm">
...
![Documentation for extending the reply abstract class](/media/blurple-py_2.webp)
...
<Figure src="/media/blurple-py_6.webm">
...
## implementing toasts with blurple
...
<Figure src="/media/blurple-py_4.webm">
