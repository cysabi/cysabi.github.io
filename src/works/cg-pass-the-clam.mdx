...
date: "2023-05"
preview: "/media/cg-pass-the-clam_1.webp"
tags:
  - "broadcast"
tools:
  - "motion.dev"
...
collage:
  - src: "/media/cg-pass-the-clam_3.webm"
    caption: "here's the reel! pay attention to the score change animation!"
  - src: "/media/cg-pass-the-clam_4.webp"
    caption: "the dashboard used for controlling the scores!"
desc:
  - |
    disclaimer, this is basically a word-vomit rant about my struggles with adobe illustrator; it took 12 hours and im making it your problem now
  - |
    if you're looking for a real devlog, check out [fabl](/work/fabl)
---
