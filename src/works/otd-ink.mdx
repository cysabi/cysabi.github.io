---
name: "otd-ink"
subtitle: "full-stack website hosting tournament signups, player accounts, and a blog"
date: "2023-01"
preview: "/media/otd-ink_1.webp"
tags:
  - "site"
tools:
  - "mdx"
...
collage:
  - src: "/media/otd-ink_14.webp"
    caption: "welcome to off the dial!"
  - src: "/media/otd-ink_11.webp"
    caption: "let's switch to dark mode for the screenshots from here"
  - src: "/media/otd-ink_5.webm"
    caption: "a multi-select autocomplete component"
  - src: "/media/otd-ink_7.webp"
    caption: "the tournament page, shows all relevant season information"
  - src: "/media/otd-ink_12.webp"
    caption: "your profile page, a dashboard for your tournament signup"
  - src: "/media/otd-ink_10.webp"
    caption: "staff page, showcases everyone involved in the running of off the dial"
  - src: "/media/otd-ink_9.webp"
    caption: "the posts page, for tournament organizers to share anything they need"
  - src: "/media/otd-ink_8.webp"
    caption: "an example post page"
desc:
  - |
    i built the website for off the dial, a tournament organization for splatoon making tournament experience accessible to players without a team!
  - |
    everything from design to development end-to-end was handled by me, including hosted player signups, custom oauth2 accounts with discord, and an embedded and easy-to-edit blog for tournament organizers to post updates.
---
...
## coming up with the information architecture
...
## picking a tech stack that costs cents per month
...
This stack let me have my cake and eat it tool! With a bit of extra work, I could support [fully-functioning oauth2 accounts](#a-custom-oauth2-client-with-firebase-functions), a signup page that's connected to a database, and more! All without needing to pay more than a couple cents.

## improving how info is communicated
...
![](/media/otd-ink_6-1.webp|/media/otd-ink_6-2.webp)
...
![](/media/otd-ink_7.webp)

## a custom discord oauth2 client with firebase functions
...
## extending a max-width container on one side
...
## a brief history of the site, and how i've progressed
...
Here's the last iteration's [pull request (+35,265 -22,311)](https://github.com/offthedial/site/pull/123)!
...
### overall user experience with the website
...
### first-time navigation and ease of finding information
