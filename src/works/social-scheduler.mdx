...
date: "2023-02"
preview: "/media/social-scheduler_1.webp"
tags:
  - "site"
tools:
  - "framer motion"
...
collage:
  - src: "/media/social-scheduler_4.webm"
    caption: "an example user flow through the app"
  - src: "/media/social-scheduler_1.webp"
    caption: "the landing page! this is what you first see when you open the app"
  - src: "/media/social-scheduler_2.webp"
    caption: "clicking on a block opens up an event booking modal"
  - src: "/media/social-scheduler_3.webp"
    caption: "once an event has been booked, the modal turns into a confirmation window"
  - src: "/media/social-scheduler_8.webp"
    caption: "the private view, showing which blocks have already been booked, and by what events"
desc:
  - |
    i was commissioned to build a web-application for a very busy client to help them simplify scheduling social events.
  - |
    features include 2-way scroll binding between the date selector and the block selector, filters for specific block types, and a very cool booking modal.
---
...
![the initial design document](/media/social-scheduler_10.webp|/media/social-scheduler_9.webp)
