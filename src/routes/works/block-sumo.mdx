export const data = {
  ...
  overview: {
    summary: (
      <>
        Inspired by Knockout City, Friends vs Friends, Mario Kart, and Smash, I
        build a easy-to-learn, hard-to-master minecraft minigame with near
        infinite levels of skill-expression, all without sacrificing
        learnability.
        <br class="mb-[1.2rem]" />
        Features include powerups with built-in comeback mechanics, and maps
        that evolve emergently through player gameplay.
      </>
    ),
    roles: ["game design"],
