export const data = {
  ...
  overview: {
    summary: (
      <>
        I wanted to make a game with a near infinite level of skill-expression,
        without sacrificing learnability. I was inspired by Knockout City,
        Friends vs Friends, and Mario Kart.
      </>
    ),
    roles: ["game design"],
...
Item rubber-banding, otherwise known as catch-up mechanics, is defined as the mechanic that allows players that are less mechanically skilled to still have an impact on the game
{/* todo: fix above */}

Learnability is important and does not need to come at the sacrifice of player expression!
...
{/* todo: break up all the text here */}
...
This is currently a passion project to help me **learn game design and development for competitive multiplayer games**. In order to grab footage for this portfolio, I hosted a playtest with a group friends for the first time, and here's what they had to say!
