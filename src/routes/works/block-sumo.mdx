export const data = {
  name: "block-sumo",
  subtitle:
    "easy-to-learn, hard-to-master minecraft minigame where you can change the battlefield",
  tags: ["game"],
  ...
  desc: (
    <>
      <p>
        i designed and developed a minecraft plugin to create a multiplayer pvp
        minigame, where maps could evolve emergently through gameplay while
        preserving new player accessibility with built-in comeback mechanics.
      </p>
      <p>
        you spawn on a floating platform with your goal to knock others off to
        score points. chaotic powerups randomly spawn for all players, with more
        powerful ones for to those who fall behind. the catch? each player has
        an infinite number of blocks in their offhand!
      </p>
    </>
  ),
  topics: ["design"],
  tools: ["papermc", "denizen"],
};

# ideation

Minecraft's movement combined with placing blocks provides you with **infinite expressions for movement** by allowing you to bend your environment to your will.

I was inspired to make a minecraft minigame that let this aspect shine, and give players a lot of creativity to solve problems.
