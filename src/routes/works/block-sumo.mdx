...
> I wanted it to be a game that you know you'll enjoy if you're bored with your friends and don't know what to play.
...
2. ### ensure item counterplay is always possible for those at the top
   ...
   **`Here's How:`** First place still has access to (less powerful) defensive items. So a lot of fun comes from using better mechanics, while **being resourceful with the defensive items you do have** to find the right counterplay to any situation.
...
3. ### encourage more emergent vertical play
   ...
   {/* TODO: stitch a bridge egg clip to it */}

   **`Here's How:`** Through the introduction of many different quick-cast mobility items, and especially an item that automatically builds a bridge, the game was able to fill that fantasy of being a 3d space.
...
4. ### Introduce a new item, a short-ranged debuff bomb that blinds and slows victims.
   ...
   {/* todo replace with a shorter video */}
