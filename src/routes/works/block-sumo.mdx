...
<Topic {...{"game design": true}}>

## game design # a scoring system that rewards aggression
...
## game design # item combos without item stockpiles
...
This way **players far behind still have a real sense of agency and ability to make an impact**.

> The further behind a player is, the more powerful items they recieve.

![Use your items strategically to claw your way back up!](/block-sumo_13.webm)

<Topic {...{"game design": true}}>

## game design # preserving counterplay for players in the lead
...
## game design # dropping items on death without a wealth gap
...
While the main role of items is to provide accesibility, they have a lot of utility as a tool that I can use influence the atmosphere
...
## game design # encouraging emergent vertical mobility
...
## game design # rebalancing snowballs and player threat-ranges

Because of the abundance of snowballs that are given to first place, it became an effective strategy for whoever was in 1st place to retreat constantly while kiting opponents away with an infinite supply of snowballs.

This was exacerbated because most of the high-power items required close range combat for them to get value. _(This was an intentional decision, because I didn't want those behind to find an easy strategy of staying on the outskirts with high-power ranged weapons to catch up)_.
