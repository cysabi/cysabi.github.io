export const data = {
  ...
  desc: "self-induced nightmare just to upscale a clam",
  ...
  overview: {
    summary: (
      <>
        Want to see the graphics in action?{" "}
        <a href="https://www.youtube.com/watch?v=9OkTnI6d6Ss">See the show!</a>
      </>
    ),
    ...
    sources: {
      github: "https://github.com/cq-overlays/cg-pass-the-clam",
    },
  },
}

{/* todo: make this more than just the word vomit? */}
