export const data = {
  ...
  desc: (
    <>
      ...
      <p>
        if you're looking for a real case study, check out{" "}
        <a
          class="font-mono font-semibold text-slate-50"
          href="https://cysabi.github.io/?work=cg-fabl"
        >
          cg-fabl
        </a>
      </p>
