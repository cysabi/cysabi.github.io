export const data = {
  ...
  overview: {
    summary: (
      <>
        Designing, building, and publishing a python library to make complex
        features with discord bots simple. Features include a multi-step
        commands, a consistent design system, and automatic toasts.
      </>
    ),
    roles: ["engineering"],
...
{/* todo: talk more about designing the system in a # design # section */}
