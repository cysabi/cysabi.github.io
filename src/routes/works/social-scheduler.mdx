export const data = {
  ...
  collage: {
    ...
    "/social-scheduler_8.png":
      "The private view, showing which blocks have already been booked, and by what events",
  },
  overview: {
    summary: (
      <>
        I was commissioned to build a web-application for a very busy client to help them
...
![Some excerpts from the initial document](/social-scheduler_10.png|/social-scheduler_9.png)
