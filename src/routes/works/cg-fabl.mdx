export const data = {
  ...
  overview: {
    summary: (
      <>
        I was tasked to collaborate with a designer to make a set of broadcast
        graphics for a Splatoon Major Tournament! But with an impossibly short
        timeframe, irl responsibilites, and unforeseen roadblocks, will I be
...
You see, the designer ended up having a lot of

You see the designer had some irl stuff going on and wasn't able to finish as much as i would have liked, so is said "i got this" and took over helping finish the designs.
