...
## design # priority 3: layout transitions
...
At the end of the day, over the course of the 6-week long event `99` unique viewers watched the games, and it wa.

Learning how to crunch and work with another designer to build broadcast graphics at a very fast pace was something.

If i were to do it again, I defiintely would have decided to give mself more time to build out the graphics.
