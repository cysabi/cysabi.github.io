export const data = {
  ...
  desc: "full-stack website including tournament signups, user accounts, and an easy-to-write blog",
...
ideation and probelm
- i needed to collect signup information to make teams, since they don't have tteams
