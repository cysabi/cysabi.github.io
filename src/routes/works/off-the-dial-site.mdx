...
I also placed a non-timezone specific schedule in the rules page, <span class="font-display px-1.5 rounded bg-yellow-400/20 backdrop-blur-xl backdrop-brightness-150">that way all of the "official" information about the tournament is coming from one source of truth</span>, not inside the idtga page.
