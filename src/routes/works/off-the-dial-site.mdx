export const data = {
  ...
  collage: {
    ...
    "/off-the-dial-site_5.webm": "A multi-select autocomplete component",
...
- ### Google Firebase
  ...
  A BaaS with an exorbitantly generous free tier, it serves all dynamic features, such as the database, authentication, and custom serverless functions.

This stack let me have my cake and eat it tool! With a bit of extra work, I could support [fully-functioning oauth2 accounts](#engineering--a-custom-oauth2-client-with-firebase-functions), a signup page that's connected to a database, and more! All without needing to pay more than a couple cents.
...
![](/off-the-dial-site_6-1.webp|/off-the-dial-site_6-2.webp)
