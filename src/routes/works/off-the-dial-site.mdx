...
My objective was to solve these design problems by **building a website that provides a single source of truth and action for Off the Dial**.
...
After researching different web hosting methods, I settled on using a jamstack website with the following technologies.
