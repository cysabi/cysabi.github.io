  ...
  overview: {
    summary: (
      <>
        ...
        truth for everything Off the Dial. This quest would end up going through
        5 iterations spanning across 5 years.
      </>
    ),
...
(iterative chunks with conflict and thought process)
